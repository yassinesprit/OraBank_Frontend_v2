...
@Component({
  ...
  styleUrl: './alias-form.component.css'
})
export class AliasFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Assuming you have access to the HTML select element with the id "country_code"
    const selectElement = document.getElementById("country_code") as HTMLSelectElement;

    // Loop through the country codes and create option elements for each code
    this.countryCodes.forEach(country => {
      const optionElement = document.createElement("option");
      optionElement.value = country.dial_code;
      optionElement.text = `${country.dial_code} (${country.name})`;
